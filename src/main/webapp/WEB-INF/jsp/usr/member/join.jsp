...
<script>
	...
	function join_submitForm(form) {
		...
		form.account.value = form.account.value.trim();
				...
				<div class="table-box-type-1">
					<table class="table">
						...
						<tbody>
							...
							<tr>
								<th>계좌번호</th>
								<td><input class="input input-bordered input-accent w-3/5" type="text" name="account" placeholder="계좌번호를 입력해주세요"/></td>
							</tr>
							<tr class="item-tr">
								<th>관심 카테고리</th>
								<td>
									<c:forEach var="category" items="${categories}">
										<div class="form-control">
											<label class="label">
	   											<input type="checkbox" name="category" value="${category.name }" class="checkbox" />
