...
public class MemberService {
	...
	public ResultData<Member> doJoin(String loginId, String loginPw, String name, String nickname, String cellphoneNum, String email, String account) {
		...
		memberDao.doJoin(loginId, loginPw, name, nickname, cellphoneNum, email, account);
	...
	public void doChargeMoney(int loginedMemberId, int money) {
		memberDao.doChargeMoney(loginedMemberId, money);
	}
	
	public void doModify(int loginedMemberId, String nickname, String cellphoneNum, String email, String account) {
		memberDao.doModify(loginedMemberId, nickname, cellphoneNum, email, account);
	}
